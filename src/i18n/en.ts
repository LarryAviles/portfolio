export default {
  ...
  hero: {
    ...
    description:
      "Software Engineer with over 7 years of experience in web applications. Specialized in web development, using AI to improve efficiency and automate processes.",
    contact: "Contact Me",
  },
  experience: {
    title: "Experience",
