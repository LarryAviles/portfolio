export default {
  ...
  hero: {
    ...
    description:
      "Ingeniero de Software con más de 7 años de experiencia en aplicaciones web. Especializado en el desarrollo web, utilizando la IA para mejorar la eficiencia y automatizar procesos.",
    contact: "Contáctame",
  },
